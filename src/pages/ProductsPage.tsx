              ...
              {filteredProducts.map((product, index) => (
                ...
                >
                  <div className="h-48 bg-gray-300 flex items-center justify-center">
                    {/* Usa o caminho placeholder para a imagem */}
        ...
        <section className="py-16 bg-gray-light">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {/* Placeholder para logos das marcas */}
              {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
                <div key={item} className="bg-white p-6 rounded-lg shadow-md flex items-center justify-center h-24">
                  {/* <img src={`/images/marcas/marca-${item}.png`} alt={`Logo Marca ${item}`} className="max-h-16 object-contain"/> */}
